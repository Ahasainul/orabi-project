...
const Proudct = () => {
  ...
  useEffect(() => {
    async function alldata() {
      let data = await axios.get(`https://dummyjson.com/products/search?q=`);
  ...
  return (
    <>
      <Container className={"py-10"}>
        ...
        <Hadding
          className={"text-4xl font-bold font-dm mt-10"}
          hedText={"Product"}
        />
        <div className="">
          ...
          <Flex className={"mt-4 items-center border-b-2 w-1/2 pb-5 "}>
            <h2 className="text-base  text-ash">
              <s>$88.00</s>
            </h2>
        ...
        <Flex className={"gap-3 items-center mt-6"}>
          <Subhadding
            className={"font-bold  text-black mr-5"}
            subText={"COLOR:"}
          />
        ...
        <Flex className={"py-8 gap-3  border-b-2 w-1/2 "}>
          <Btn
            className={"px-8 hover:bg-white border  hover:text-black"}
            btnName={"Add to Wish List"}
          />
          <Btn
            className={"px-12 hover:bg-white border  hover:text-black"}
            btnName={"Add to Cart "}
          />
        </Flex>
        ...
        <Subhadding
          ...
          className={" text-base w-1/2 py-8 font-semibold"}
        />
      </Container>
    </>
  );
